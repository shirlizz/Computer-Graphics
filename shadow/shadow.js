...
// matrix for shadow projection
    ...
    pointsArray.push(vec4(  0.5, 0.5, 0.5,)); 
    pointsArray.push(vec4(0.5, -.5, 0.5,)); 
    pointsArray.push(vec4(-.5, 0.5, 0.5,)); 
   pointsArray.push(vec4( -.5, 0.5, 0.5,)); 
   pointsArray.push(vec4( 0.5, -.5, 0.5,)); 
   pointsArray.push(vec4( -.5, -.5, 0.5,)); 

    // Left
    pointsArray.push(vec4(-.5, 0.5, 0.5,)); 
    pointsArray.push(vec4(-.5, -.5, 0.5,)); 
   pointsArray.push(vec4( -.5, 0.5, -.5,)); 
   pointsArray.push(vec4( -.5, 0.5, -.5,)); 
   pointsArray.push(vec4( -.5, -.5, 0.5,)); 
   pointsArray.push(vec4( -.5, -.5, -.5,)); 

    // Back
   pointsArray.push(vec4( -.5, 0.5, -.5,)); 
   pointsArray.push(vec4( -.5, -.5, -.5,)); 
   pointsArray.push(vec4( 0.5, 0.5, -.5,)); 
    pointsArray.push(vec4(0.5, 0.5, -.5,)); 
   pointsArray.push(vec4( -.5, -.5, -.5,)); 
   pointsArray.push(vec4( 0.5, -.5, -.5, ));         
